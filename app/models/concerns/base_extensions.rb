module BaseExtensions
  ...
  class_methods do
    ...
    def current_user_type
      Auditing::CurrentUser.user_type
    end

    def current_user_id
      Auditing::CurrentUser.user_id
    end

    def current_user_ip
      Auditing::CurrentUser.user_ip
    end
    ...
    def table_name_without_schema
      @table_name_without_schema ||= table_name_has_schema? ? table_name.split('.').last : table_name
    end

    def table_name_with_schema
      @table_name_with_schema ||= "#{table_schema}.#{table_name_without_schema}"
    end
